...
2. 기본: 현재 채널 멤버가 대상으로 선택됨 (필요 시 변경 가능)
...
- 🌐 **다국어 도움말**: `/shuffle help` 메시지는 사용자의 Slack 언어 설정에 따라 한국어/일본어/중국어/영어로 표시됩니다
- 🔄 **캐시**: 유저 이름은 10분, 채널 멤버 목록은 2분 간격으로 갱신됩니다. 최근 추가/제거된 멤버가 즉시 반영되지 않을 수 있습니다
- 🚫 **제외 목록**: 대상 인원이 100명 이하일 때만 제외 선택 UI가 표시됩니다 (Slack Block Kit 제한)
